...
Last global check date: **2026-04-02**
...
| vLLM | [vllm-project/vllm](https://github.com/vllm-project/vllm) | [#36821 no `sm_121` support on aarch64 DGX Spark](https://github.com/vllm-project/vllm/issues/36821), [#38484 add SM121 to published build targets](https://github.com/vllm-project/vllm/pull/38484), [DGX Spark validation comment](https://github.com/vllm-project/vllm/pull/38484#issuecomment-4175932011) | pending-review | 2026-04-02 | `docs/troubleshooting.md` (vLLM section), `docker/vllm/Dockerfile` |
...
- vLLM verification (2026-04-02): DGX Spark smoke passed on `v0.18.0` with `v1_flashattn` (`/health OK`, `/v1/models` non-empty).
